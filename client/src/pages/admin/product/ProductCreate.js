...
const initialState = {
  ...
  colors: ["Đen", "Nâu", "Vàng", "Trắng", "Xanh"],
  brands: ["Adidas", "Tommy", "Thom Browne", "Burberry", "Dior"],
  color: "White",
  brand: "Apple",
};
...
const ProductCreate = () => {
  ...
  const handleSubmit = (e) => {
    ...
    createProduct(values, user.token)
      .then((res) => {
        console.log(res);
        window.alert(` Sản phẩm "${res.data.title}" đã được tạo`);
      ...
      <div className="row">
        ...
        <div className="col-md-10">
          {loading ? (
            ...
            <h4>Tạo sản phẩm mới cho cửa hàng của bạn </h4>
          )}
          <hr />
